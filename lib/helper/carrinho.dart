...
class ItemCarrinho{
  ...
  ItemCarrinho(this.idProduto, this.descricaoProduto, this.imagemProduto, this.quantidade, this.valor, this.situacao, this.observacao, this.adicionaisEscolhidos);
...
class AdicionalEscolhido {
  ...
  AdicionalEscolhido(this.id, this.descricao, this.descricaoVariacao, this.valor);

  factory AdicionalEscolhido.fromJson(Map<String, dynamic> json) => _$AdicionalEscolhidoFromJson(json);
