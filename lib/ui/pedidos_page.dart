          ...
          switch (snapshot.connectionState) {
            ...
            default:
              if (snapshot.hasError) {
                ...
                return listResumos(snapshot.data);
              }
          }
        },
      ),
...
//    print(resumos[0].getParceiroImagem);
    if (resumos.length == 0){
      return Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: <Widget>[
          Icon(Icons.list,size: 80, color: Theme.of(context).accentColor,),
          Padding(padding: EdgeInsets.all(10),
            child: Text("Seus pedidos aparecerão aqui ",style: TextStyle(color: Theme.of(context).accentColor,fontSize: 16)),
          ),
          Text("Faça seu primeiro pedido agora mesmo ☺",style: TextStyle(color: Colors.black,fontSize: 13)),
        ],
      );
    }else{
      return Column(
                    ...
                    ListTile(
                        ...
                        subtitle: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(resumos[index].cancelamento
                        ...
                        leading: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image: ImageUtil.loadWithRetry(resumos[index].getParceiroImagem)
                              )
                          ),
                        ),
                        trailing: Column(
                          ...
                          children: <Widget>[
                            Text(resumos[index].getPreco,  style: TextStyle(fontSize: 11.0,fontWeight: FontWeight.bold, color:Colors.black)),
                            Text(resumos[index].getTempo,  style: TextStyle(fontSize: 12.0, color: Colors.black)),
//                  Divider(height: 15.0,color: Colors.red),
                          ],),
                        onTap: (){
                          Navigator.of(context).push(MaterialPageRoute(builder: (context){
                            return PedidoShowPage(resumos[index].id, resumos[index].codigo);
                          }));
