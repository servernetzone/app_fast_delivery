...
//                                   ),
  ...
  _favoritar() async {
    ...
    await ParceiroDao.internal()
        .favoritar(favorito: Favorito(_idCliente, _parceiro.id, _favorito));
    Provider.of<FavoritosModel>(context, listen: false).getParceirosFavoritos();
  }
