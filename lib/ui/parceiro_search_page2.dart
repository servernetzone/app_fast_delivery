...
class ParceiroSearchPage2 extends StatefulWidget {

  Future<List<Parceiro>> _futureParceiros;
  ParceiroSearchPage2(this._futureParceiros);
  @override
  _ParceiroSearchPage2State createState() => _ParceiroSearchPage2State();
}

class _ParceiroSearchPage2State extends State<ParceiroSearchPage2> {
...
//    _todosparceiros = widget._parceiros;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: widget._futureParceiros,
