...
//    _formaPagamentoDao = FormaPagamentoDao();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Como prefere pagar?', style: TextStyle(fontSize: 16.0)),
        centerTitle: true,
      ),
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              child: Wrap(
                                ...
                                children: _verifyPaymentForm(
                                    context, snapshot, 'DINHEIRO'),
                              ),
                            ),
                            SizedBox(height: 10.0),
                            ...
                            Container(
                              ...
                              child: Wrap(
                                ...
                                direction: Axis.horizontal,
                                children: _verifyPaymentForm(
                                    context, snapshot, 'DEBITO'),
                              ),
                            ),
                            SizedBox(height: 10.0),
                            Text(
                                'Pagamento com saldo. Saldo atual: ${FormatUtil.adicionaMascaraDinheiro(FormatUtil.doubleToPrice(Session.getCliente().saldo))}',
                                style: TextStyle(
                                    color: Theme.of(context).accentColor,
                                    fontSize: 13.0,
                                    fontWeight: FontWeight.bold)),
                              ...
                              child: Container(
                                  ...
                                  child: ListTile(
                                    ...
                                    onTap: () {
                                      ...
                                      Session.getPedido().porcentagemCartao =
                                          Session.getParceiro()
                                              .porcentagemCartao;
                                      ...
                                      print(
                                          'id: ${Session.getFormaPagamento().id}');
                                      print(
                                          'descrição: ${Session.getFormaPagamento().descricao}');
                                      print(
                                          'tipo: ${Session.getFormaPagamento().tipo}');
                                    },
                                  )),
                            ),
                            Container(
                              ...
                              child: Text(
                                'O pagamento é realizado no ato da entrega do pedido.'
      ...
      bottomNavigationBar: BottomAppBar(
          ...
          child: Container(
              decoration: BoxDecoration(
                  border: Border(
                      top: BorderSide(
                          color: Configuration.colorWrite1.withOpacity(0.5),
                  ...
                  children: <Widget>[
                    Text(
                      Session.getPedido().entrega == true
                          ...
                          : 'Produtos',
                      style: TextStyle(
                          fontSize: 11.0, color: Configuration.colorAccent1),
                    ),
                    Text(
                      Session.getPedido().entrega == true
                          ? FormatUtil.adicionaMascaraDinheiro(
                              FormatUtil.doubleToPrice(_valorTotal))
                          : FormatUtil.adicionaMascaraDinheiro(
                              FormatUtil.doubleToPrice(_valorCompra)),
                      style: TextStyle(
                          fontSize: 12.0,
                          color: Configuration.colorAccent1,
                          fontWeight: FontWeight.bold),
...
//    print(Session.getPedido().valorEntrega);
  ...
  List<Widget> _verifyPaymentForm(
      BuildContext context, AsyncSnapshot snapshot, String tipo) {
                ...
                if (tipo == 'DINHEIRO') {
                  ...
                  if (Session.getParceiro().porcentagemCartao == 0.0) {
                    _formasPagamentoPedido = FormasPagamentoPedido(
                        formaPagamento.id,
                        _valorCompra + Session.getPedido().valorEntrega);
                    Session.getPedido().valorPagoCliente =
                        _valorCompra + Session.getPedido().valorEntrega;
                    Session.setFormaPagamento(formaPagamento);
                    ...
                    print(
                        'Session.getPedido().pagamentosPedido[0].formaPagamento: ${Session.getPedido().pagamentosPedido[0].formaPagamento}');
                    print(
                        'Session.getPedido().pagamentosPedido[0].valor: ${Session.getPedido().pagamentosPedido[0].valor}');
                  } else {
                    _valorTaxa = _valorCompra *
                        (Session.getParceiro().porcentagemCartao / 100);
                        ...
                        [
                          FlatButton(
                              ...
                              onPressed: () {
                                ...
                                print(
                                    'porcentagem: ${(Session.getParceiro().porcentagemCartao / 100)}');
                                print('valor calculado: $_valorTaxa');
                                print(
                                    'valor total: ${_valorCompra + _valorTaxa}');
                                _formasPagamentoPedido = FormasPagamentoPedido(
                                    formaPagamento.id,
                                    _valorCompra +
                                        Session.getPedido().valorEntrega);
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                RaisedButton(
                                    ...
                                    color:
                                        Configuration.colorRed.withOpacity(0.2),
                                    ...
                                    onPressed: () {
                                      ...
                                      print(
                                          'formaPagamentoId: ${Session.getPedido().pagamentosPedido[0].formaPagamento}');
                                      print(
                                          'pagamentosPedido[0].valor: ${Session.getPedido().pagamentosPedido[0].valor}');
                                    }),
                                RaisedButton(
                                    child: Text(
                                      "Sim",
                                ...
                                Form(
                                  ...
                                  child: TextFormField(
                                    ...
                                    validator: (value) {
                                      ...
                                      print(
                                          'valor do frete ${Session.getPedido().valorEntrega}');
                                      if (value.isEmpty) {
                                        return 'Preencha o campo para prosseguir!';
                                      }

                                      _valorTrocoController.numberValue;
                                      print(_valorTrocoController.numberValue);
                                      if (_valorTrocoController.numberValue <=
                                          (_valorCompra +
                                              Session.getPedido()
                                                  .valorEntrega)) {
                                ...
                                FlatButton(
                                    ...
                                    onPressed: () {
                                      if (_formKey.currentState.validate()) {
                                        ...
                                        Session.getPedido().porcentagemCartao =
                                            0.0;
                                        Session.getPedido().pagoComSaldo =
                                            false;
                                        Navigator.of(context).pop();
                                        Navigator.of(context).push(
                                            MaterialPageRoute(
